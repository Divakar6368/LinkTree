...
const getSocialIcon = (platform: string) => {
  switch (platform.toLowerCase()) {
    case "instagram":
      return <FaInstagram className="h-15 w-15" />;
    case "youtube":
      return <FaYoutube className="h-15 w-15" />;
    case "twitter":
      return <FaTwitter className="h-15 w-15" />;
    case "github":
      return <FaGithub className="h-15 w-15" />;
    case "linkedin":
      return <FaLinkedin className="h-15 w-15" />;
    default:
        ...
        >
          ...
          <div
            className={`absolute inset-0 pointer-events-none transition-opacity duration-300 ${theme === "dark"
              ? "bg-linear-to-br from-zinc-800/20 via-transparent to-zinc-900/20"
              : "bg-linear-to-br from-gray-50/20 via-transparent to-gray-100/20"
              }`}
          />
